...
require("./thomzkece")(haikal, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
...
connectToWhatsApp();
  ...
  haikal.sendMessage('6283820352529' + "@s.whatsapp.net", { text: `BOT ON YAH BANG BELI PANEL DI PUTZ GNZ BUY SCNYA JUGA DI ZEUXSS STORE
